...
_v8_commit="05fb6e97fc6c5fdd2e79e4f9a51c5bf0ca0ef991"
SRC_URI="
	$(cargo_crate_uris)
	https://github.com/denoland/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/denoland/v8/archive/${_v8_commit}.tar.gz
"

# License set may be more restrictive as OR is not respected
# use cargo-license for a more accurate license picture
LICENSE="0BSD Apache-2.0 Apache-2.0-with-LLVM-exceptions Artistic-2 BSD BSD-2 Boost-1.0 CC0-1.0 ISC MIT MPL-2.0 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"
...
src_prepare() {
	...
	rm -rf ../cargo_home/gentoo/v8-0.60.1/v8
	cp -r ../v8-${_v8_commit} ../cargo_home/gentoo/v8-0.60.1/v8
}
